...
Extract: Your code that downloads the data from the link.

Transform: Your Python script that cleans the null values and fixes the names.

Load: (Your next step) Saving that clean data into a new file or a database.